...
(function() {
    ...
    var is = {
        ...
        set: function(shape) {
            ...
            cache.isLine = cache.isArrow = cache.isArc = cache.isDragLastPath = cache.isDragAllPaths = cache.isRectangle = cache.isQuadraticCurve = cache.isBezierCurve = cache.isPencil = cache.isMarker = cache.isEraser = cache.isText = cache.isImage = cache.isPdf = cache.snap = cache.clear = false;
            cache['is' + shape] = true;
        }
    };
        ...
        function decoratesnap() {
            ...
            image.onload = function() {
                ...
                document.querySelector('#snap').onclick = function() {
                    ...
                    downloadLink.setAttribute('download', new Date().getTime() + '.png');
